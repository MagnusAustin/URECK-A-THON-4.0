...
from app.ml_models.sense2vec_distractor_generation.models.sense2vec_generation import Sense2VecDistractorGeneration
...
class MCQGenerator():
    ...
    def generate_mcq_questions(self, context: str, desired_count: int) -> List[Question]:
        ...
        for question in questions:
            ...
            # Insert correct answer randomly into the distractors list
            distractors_with_answer = question.distractors.copy()  # Create a copy to avoid modifying the original list
            random_index = random.randint(0, len(distractors_with_answer))  # Choose a random index
            distractors_with_answer.insert(random_index, question.answerText)  # Insert the correct answer
            print("Options (including correct answer):", distractors_with_answer)
